let itemCode,productID,productImg,productName,productColor,sizeValue,productPrice,qty=0,maxVal;document.querySelector("#productID")&&(productID=document.querySelector("#productID").value),document.querySelector(".product-highlight img")&&(productImg=document.querySelector(".product-highlight img").src),document.querySelector(".product-name")&&(productName=document.querySelector(".product-name").textContent),document.querySelector("#productColor")&&(productColor=document.querySelector("#productColor").textContent),document.querySelector("#sizeOpt")&&(sizeValue=document.querySelector("#sizeOpt").value),document.querySelector("#productPrice")&&(productPrice=document.querySelector("#productPrice").textContent,productPrice=parseInt(productPrice.replace(/,/g,""))),document.querySelector("#quantity")&&(maxVal=document.querySelector("#quantity").max,maxVal=parseInt(maxVal)),itemCode=null!=sizeValue?productName+" "+sizeValue:productName;let products={itemCode:itemCode,productID:productID,productImage:productImg,productName:productName,productColor:productColor,productSize:sizeValue,productPrice:productPrice,Quantity:qty,maxValue:maxVal};const cartBtn=document.querySelector("#cart-btn");function setProducts(t){let e=localStorage.getItem("productsInCart");e=JSON.parse(e);var n=document.querySelector("#quantity").value,n=parseInt(n);null!=e?(null==e[t.itemCode]&&(e={...e,[t.itemCode]:t}),e[t.itemCode].Quantity+=n):(t.Quantity=n,e={[t.itemCode]:t}),e[t.itemCode].Quantity<=e[t.itemCode].maxValue&&(localStorage.setItem("productsInCart",JSON.stringify(e)),cartNumbers())}function onLoadCartNumbers(){var t=localStorage.getItem("cartNumbers");t&&(document.querySelector("#counter").textContent=t)}function cartNumbers(){var t=localStorage.getItem("cartNumbers"),t=parseInt(t),e=document.querySelector("#quantity").value,e=parseInt(e);t?(localStorage.setItem("cartNumbers",t+e),document.querySelector("#counter").textContent=t+e):(localStorage.setItem("cartNumbers",e),document.querySelector("#counter").textContent=e)}function displayCart(){var t=localStorage.getItem("productsInCart"),t=JSON.parse(t);let e=document.querySelector("#cart");null===t||0==localStorage.getItem("cartNumbers")?e&&(e.innerHTML="",e.innerHTML+=`
    ...
    </div>`),numberWithCommas(),minusBtnProperty(),plusBtnProperty(),subTotal()}function numberWithCommas(){const t=document.querySelectorAll(".item-price p"),e=document.querySelectorAll(".total-price");t.forEach(t=>{let e=t.textContent;e=parseInt(e);var n=e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2});t.innerText=n}),e.forEach(t=>{let e=t.textContent;e=parseInt(e);var n=e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2});t.innerText=n})}function minusBtnProperty(){const t=document.querySelectorAll(".minus-btn");t.forEach(t=>{t.nextElementSibling.classList.contains("quantity")&&1==t.nextElementSibling.value&&(t.setAttribute("disabled","disabled"),t.style.cursor="not-allowed")})}function plusBtnProperty(){const t=document.querySelectorAll(".plus-btn");t.forEach(t=>{t.previousElementSibling.classList.contains("quantity")&&t.previousElementSibling.value==t.previousElementSibling.max&&(t.setAttribute("disabled","disabled"),t.style.cursor="not-allowed")})}function minus(o){if(o.nextElementSibling.classList.contains("quantity")){var r=o.nextElementSibling.value,l=o.nextElementSibling.max;1==(o.nextElementSibling.value=--r)&&(o.setAttribute("disabled","disabled"),o.style.cursor="not-allowed"),r!=l&&(o.nextElementSibling.nextElementSibling.removeAttribute("disabled"),o.nextElementSibling.nextElementSibling.classList.remove("disabled"),o.nextElementSibling.nextElementSibling.style.cursor="pointer");let t=o.parentNode.previousElementSibling.childNodes[3].textContent;const c=o.parentNode.nextElementSibling.childNodes[3];let e=c.textContent;e=parseInt(e.replace(/,/g,"")),t=parseInt(t.replace(/,/g,"")),t=e-t,c.innerText=t.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2});let n=o.parentNode.previousElementSibling.childNodes[3].textContent;n=parseInt(n.replace(/,/g,""));let i=document.querySelector("#subtotal-price");o=parseInt(i.textContent.replace(/,/g,""));let a=0;a=o-n,i.innerText=a.toLocaleString()}}function plus(o){if(o.previousElementSibling.classList.contains("quantity")){var r=o.previousElementSibling.value,l=o.previousElementSibling.max;1<(o.previousElementSibling.value=++r)&&(o.previousElementSibling.previousElementSibling.removeAttribute("disabled"),o.previousElementSibling.previousElementSibling.classList.remove("disabled"),o.previousElementSibling.previousElementSibling.style.cursor="pointer"),r==l&&(o.setAttribute("disabled","disabled"),o.style.cursor="not-allowed");let t=o.parentNode.previousElementSibling.childNodes[3].textContent;const c=o.parentNode.nextElementSibling.childNodes[3];let e=c.textContent;e=parseInt(e.replace(/,/g,"")),t=parseInt(t.replace(/,/g,"")),t=e+t,c.innerText=t.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2});let n=o.parentNode.previousElementSibling.childNodes[3].textContent;n=parseInt(n.replace(/,/g,""));let i=document.querySelector("#subtotal-price");o=parseInt(i.textContent.replace(/,/g,""));let a=0;a=o+n,i.innerText=a.toLocaleString()}}function subTotal(){const t=document.querySelector("#subtotal-price"),e=document.querySelectorAll(".total-price");let n=0;e.forEach(t=>{totalPrice=parseInt(t.textContent.replace(/,/g,"")),n+=totalPrice}),t&&(t.innerText+=n.toLocaleString())}function removeItem(t){var e=localStorage.getItem("cartNumbers"),e=parseInt(e),n=localStorage.getItem("productsInCart"),n=JSON.parse(n);let i=t.parentNode.childNodes[3].value;t=t.nextElementSibling.value;n=Object.values(n).filter(t=>t.itemCode!==i),e&&(localStorage.setItem("cartNumbers",e-t),document.querySelector("#counter").textContent=e-t),localStorage.setItem("productsInCart",JSON.stringify(n)),displayCart()}cartBtn&&cartBtn.addEventListener("click",()=>{setProducts(products)}),displayCart(),onLoadCartNumbers();