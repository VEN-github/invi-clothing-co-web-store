  ...
  <body id="page-top">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-4 text-gray-800">Cash on Delivery (COD) - Payments</h1>
            ...
            <div class="d-none d-print-block">
              <div class="d-sm-flex align-items-center justify-content-between m-4">
                <h1 id="heading" class="m-0 font-weight-bold text-gray-800">COD - Payments List</h1>
            ...
            <div class="card shadow mb-4 d-print-none">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-gray-800">
                  Cash on Delivery (COD) - Payments List
                </h6>
              </div>
              <div class="card-body">
                <div class="table-responsive">
    ...
    <script>
      function genPDF(){
        ...
        doc.save("Cash on Delivery (COD) - Payments.pdf");
      }
    </script>
  </body>
</html>