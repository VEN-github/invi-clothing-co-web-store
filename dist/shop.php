...
?>
          ...
          <div class="container">
            ...
            <div class="shop-grid">
              <div data-sal="slide-right" data-sal-duration="1200" data-sal-delay="300" data-sal-easing="ease-out-bounce" class="categories">
                <p>Categories<span class="plus-icon">+</span></p>
              ...
              <?php if ($displayProducts) { ?>
                <?php foreach ($displayProducts as $product) { ?>
                  <?php if ($product["availability"] === "Available") { ?>
                    <div data-sal="zoom-out" data-sal-duration="1200" data-sal-delay="400" data-sal-easing="ease-out-bounce" class="products <?= $product[
                      "categoryName"
                    ] ?> <?= strtoupper(
   $product["productName"]
  ...
  "coverPhoto"
                        ...
                        <div class="price-container">
                          ...
                          <?php if ($product["salesDiscount"]) { ?>
                            <p class="price sales-amount">
                              <?= number_format($product["salesAmount"], 2) ?>
                            </p>
                          <?php } ?>
                        </div>
                      </div>
                  ...
                  <?php } ?>
                <?php } else { ?> 
                <div data-sal="zoom-out" data-sal-duration="1200" data-sal-delay="400" data-sal-easing="ease-out-bounce" class="container no-data"><img src="./assets/img/empty-order.svg" alt="No Data"><p>No Data Available</p></div>
                <?php } ?>
              </div>
